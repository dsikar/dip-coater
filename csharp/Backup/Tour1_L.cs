...
; Copyright (c) 2005 by Trace Systems, Inc.  
 ...
 File created: 28/10/2009 17:49:10
...
using System.Collections;
    ...
    // the report from the device, then accessing the properties InVar1 etc.
    // For array variables, see the special instructions below.
    //
    //  OutputRptB :
    //    OurVar1  - 8 bit value
    // You may write these variables by first setting the properties InVar1 etc.,
    ...
    public const string HM_PROJECT_NAME = "HIDmaker FS Quick Tour";

    // Declare as constants the information about the TYPE of device we know about
    public const int MY_VID = 0x1111;      // Expected Vendor ID
    public const bool MATCH_MY_VID = true;  // Set true to try to match this parameter

    public const int MY_PID = 0x1111;     // Expected Product ID
    ...
    public const string MY_PROD = "HIDmaker FS Quick Tour";    // Prod name string
    public const bool MATCH_MY_PROD = false;  // Set true to try to match this parameter

    public const int MY_VER = 1;            // Version number
    ...
    private const string INVAR1_NAME = "InVar1";   // No spaces, please! Will become a property name!
    private const int INVAR1_USG_PG = 0x0001;
    private const int INVAR1_USG = 0x0030;
    private const int INVAR1_RPT_TYPE = 0;  // Input   (0 = Input,  1 = Output,  2 = Feature)
    private const int INVAR1_IDENTITY = 1;  // Config or Identity this var belongs to

    private const string INVAR2_NAME = "InVar2";   // No spaces, please! Will become a property name!
    private const int INVAR2_USG_PG = 0x0001;
    private const int INVAR2_USG = 0x0031;
    private const int INVAR2_RPT_TYPE = 0;  // Input   (0 = Input,  1 = Output,  2 = Feature)
    private const int INVAR2_IDENTITY = 1;  // Config or Identity this var belongs to

    private const string OURVAR1_NAME = "OurVar1";   // No spaces, please! Will become a property name!
    private const int OURVAR1_USG_PG = 0x0001;
    private const int OURVAR1_USG = 0x003E;
    private const int OURVAR1_RPT_TYPE = 1;  // Input   (0 = Input,  1 = Output,  2 = Feature)
    private const int OURVAR1_IDENTITY = 1;  // Config or Identity this var belongs to
    ...
    private TOneHidVar FInVar1;
    private TOneHidVar FInVar2;
    private TOneHidVar FOurVar1;
    ...
    public TTourDev()
    {
      ...
      FInVar1 = new TOneHidVar(INVAR1_RPT_TYPE, INVAR1_USG_PG,
         INVAR1_USG, INVAR1_IDENTITY, INVAR1_NAME);
      FVariables.Add(FInVar1);

      FInVar2 = new TOneHidVar(INVAR2_RPT_TYPE, INVAR2_USG_PG,
         INVAR2_USG, INVAR2_IDENTITY, INVAR2_NAME);
      FVariables.Add(FInVar2);

      FOurVar1 = new TOneHidVar(OURVAR1_RPT_TYPE, OURVAR1_USG_PG,
         OURVAR1_USG, OURVAR1_IDENTITY, OURVAR1_NAME);
      FVariables.Add(FOurVar1);

    }  // constructor: public TTourDev()
    //---------------------------------------------------------------------------
    ...
    public TOneHidVar InVar1
    {
      get { return FInVar1; }
      set { FInVar1 = value; }
    }  // public property TOneHidVar InVar1
    //---------------------------------------------------------------------------

    public TOneHidVar InVar2
    {
      get { return FInVar2; }
      set { FInVar2 = value; }
    }  // public property TOneHidVar InVar2
    //---------------------------------------------------------------------------

    public TOneHidVar OurVar1
    {
      get { return FOurVar1; }
      set { FOurVar1 = value; }
    }  // public property TOneHidVar OurVar1
    //---------------------------------------------------------------------------
